...
export default function LettreChargeComDigitale() {
      ...
      <A4Shader />
        ...
        <div className="mb-8 pb-4 border-b border-gray-200">
          <p className="text-[12px]">
            ...
            <span className="text-gray-700 ml-2">
              Candidature pour une alternance de chargé·e de communication digitale à partir de septembre 2026
            </span>
          </p>
        </div>
        ...
        <div className="text-[12px] leading-[1.8] text-gray-800 text-justify space-y-5">
          ...
          <p>
            ...
            {' '}je suis à la recherche d'une alternance à partir de septembre 2026 en tant que chargé·e de communication digitale.
          </p>

          <p>
            Ma formation m'a permis de développer des compétences solides en <strong>création de contenus visuels</strong>,
            en <strong>stratégie de communication</strong> et en <strong>gestion des réseaux sociaux</strong>.
            Je maîtrise des outils tels qu'<strong>Adobe Photoshop</strong>, <strong>Illustrator</strong> et <strong>Figma</strong>
            pour la conception graphique, ainsi que des notions de <strong>rédaction web</strong> et de <strong>SEO</strong>.
            Au fil de mes projets universitaires, j'ai également acquis une expérience en <strong>production vidéo</strong>
            et en <strong>montage</strong>, ce qui me permet d'avoir une vision globale des supports de communication digitaux.
          </p>

          <p>
            Mon sens de l'esthétique, développé à travers mes projets personnels en graphisme et en audiovisuel,
            me permet de concevoir des contenus cohérents avec l'identité visuelle d'une structure.
            Je suis particulièrement attentif à l'impact et à la lisibilité des messages diffusés en ligne,
            et j'aime concevoir des campagnes qui allient créativité et efficacité.
          </p>

          <p>
            Cette alternance représente pour moi une opportunité
            idéale de mettre mes compétences au service de votre communication, tout en approfondissant
            ma maîtrise des outils et stratégies digitales dans un environnement professionnel stimulant.
          </p>
        ...
        <div className="mt-auto pt-6 border-t border-gray-200">
          <div className="flex justify-between items-center text-[10px] text-gray-400">
            <span>Rafael Piral  Candidature Chargé·e de Communication Digitale</span>
