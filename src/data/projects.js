...
export const projects = [
  ...
  },
  {
    ...
    duration: "En cours",
    description: "Projet en équipe — Mon rôle : création du logo et de la charte graphique pour la plateforme réseau alumni de l'IUT de Bobigny. Ce projet vise à connecter anciens diplômés, entreprises et personnels de l'établissement à travers une plateforme intégrant des fonctionnalités de réseau social, un CRM, un système de mise en relation recruteurs/candidats, une CVthèque et un annuaire géolocalisé. J'ai conçu l'identité visuelle complète : logo, palette de couleurs, typographies et charte graphique, en respectant l'image institutionnelle de l'IUT tout en apportant une dimension moderne et\u00A0professionnelle.",
