...
const Shuffle = ({
  ...
  useGSAP(
    () => {
      ...
      if (userHasFont) {
        ...
        computedFont = `'Ethic New', sans-serif`;
      }
      ...
      const build = () => {
        ...
        chars.forEach(ch => {
          ...
          Object.assign(wrap.style, { width: w + 'px', marginRight: '0.15em' });
          ...
          Object.assign(firstOrig.style, { width: w + 'px', fontFamily: computedFont, fontWeight: randWeight() });

          ch.setAttribute('data-orig', '1');
          ch.className = 'inline-block text-left';
          Object.assign(ch.style, { width: w + 'px', fontFamily: computedFont, fontWeight: randWeight() });
          ...
          for (let k = 0; k < rolls; k++) {
            ...
            Object.assign(c.style, { width: w + 'px', fontFamily: computedFont, fontWeight: randWeight() });
            inner.appendChild(c);
          }
  ...
  const Tag = tag || 'span';
  const commonStyle = { textAlign, fontFamily: 'Ethic New', ...style };
